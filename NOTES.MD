...
What is a Git Stash?
Now what Stash will do is it will take your changes and save it so that next time when you're coming back to this particular branch, you can use this stash. So basically, if you want to save your code without committing and when you come back here, of course one of the way you can delete the code, okay? So you can delete this and you are all good, right? But I dont wanna do that, I dont wanna delete this. What if you can save this? And the way you can do that is by using something called a Git Stash.
# git stash
Now once you have done that, it looks like it is deleted, but it's not. It is saved, so you can come back here and use it. 
# git stash list -> It will give you all these stash which you have done
# git stash apply -> It will give you the saved things will be applied again here
# git switch main -> after git stash have done, we can switch to other branch without commit

Git Fork?
Why do we need this thing?
Lets say you are searching for the particular repository, and whatever the repository is not yours, but someone else's. I'm searching for vscode and this is basically a VS Code repository, so they have the entire here. Now what if we want to make some changes here. And you can see I have this repository. In fact, we download the repository, we tried to do something. Of course, you can download the entire repository in your own machine. But what if you want to make some changes? and what if I want these changes to be used by everyone? I want to make real changes in this particular repository. Is it really possible? Actually not, and even if you clone this project, if you have a local copy of it and if you make changes, if you try to push the changes, it will not work because you are not allowed. You are not even a contributor here. In that case, what you will do is you will use something called a fork there. In this regard, I can make the changes but it'll only available in my repository, OK? so if you want to push, so you can now. So you can just clone this project, make some changes. So you can just clone this project, make the changes and push it, but you're pushing in your own repository. NOT ON MICROSOFT REPO. That you can do. Once you make some changes, you can create something called a pull request. Of course, we'll see pull request later, but at this point, this is how you basically fork, and the repositories will be available on your machine, OK? Thats it, thats basically forking.

How do we create a Pull Request?
What if you make some changes in your own in the project.
And you want the entire world to use it?
So of course you have to ask Microsoft people, or the community to accept your changes.
1. Forking the repo
2. Cloning it onto our own local repo
3. Making some changes
4. Adding, Committing, and Pushing
In this case, if you want the changes to be applied to the main account, or for everyone to use, what we can do is we can create something called a Pull Request (PR).
The way you can do that is by going to the right side of code tab which is Pull Request. Create new Pull Request. And the moment you do that, you can see there's something here which says, the base repository, which is navinreddy20, your project you have working on. And we will be able to merge it because I dont think there's any conflict there. So we can create a PR. And the changes we have made is huge change. We just added a comment in Java file. Once you do that, you can click on the Create Pull Request, you can add your comment here. you can say, "comments are important for this code". Thats it. Then once you click this, the PR has been sent. It is open now. This branch has no conflict with the base branch.
Now lets see to the Reviewer side, the one who got PR request. And when you click on PR here, so you can see we got a PR.
Now who has sent this PR? teluskotraining has sent this PR. So it is my job to see his PR. You cant simply accept any PR, right? Anyone can send any type of code. We have to review the code. The code review is very important. So when you open the PR, check the changes. So you can just go down, and you can see the changes here. What changes they have made. There's only one change and the comment added. What are the changes? It's the controller the quiz that this comment is added, and I feel thats important. 
The way you can accept it is with the help of Merge Pull Request. When you click this, the same comment, commit merge, changes, done.
And if you see here, on our account as reviewer. It says Pull Request is closed. Because I have done the merging on the main account. So thats done. PR is complete, merge happened. And if I go back to Code now, look at the changes. So the SRC is being changed three mintues ago. So thats basically you can contribute to the open source project.